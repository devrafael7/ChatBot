            ...
            <form className="flex w-full pt-6 pb-9 h-full flex-col items-center px-8 bg-white" action="">
                {isVisible && (
                    <DefaultInput
                        ...
                        className="w-full py-4 px-4 mb-4"
                        type="text"
                        placeholder="User"
                    />
                )}
                <DefaultInput value={email} onChange={e => setEmail(e.target.value)} className="w-full py-4 px-4 mb-4" type="text" placeholder="Email" />
                <DefaultInput value={password} onChange={e => setPassword(e.target.value)} className="w-full py-4 px-4" type="password" placeholder="Password" />
